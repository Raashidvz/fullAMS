...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2024 at 10:35 PM
...
(3, 'BCA2022', 2022, 'BCA', 1, 1, 1, 1, 1, 0, 0, 0),
(4, 'BCA2023', 2023, 'BCA', 1, 1, 1, 1, 1, 0, 0, 0);
...
(2, 'COMPUTER GRAPHICS', 'BCA', 3, 4, NULL, NULL),
(3, 'MICROPROCESSOR AND PC HARDWARE', 'BCA', 3, 5, NULL, NULL),
(4, 'OPERATING SYSTEMS', 'BCA', 3, 5, NULL, NULL),
(5, 'DATA STRUCTURE USING C++', 'BCA', 3, 5, NULL, NULL),
(6, 'COMPUTER NETWORKS', 'BCA', 5, 5, NULL, NULL),
(7, 'IT AND ENVIRONMENT', 'BCA', 5, 5, NULL, NULL),
(8, 'JAVA PROGRMMING USING LINUX', 'BCA', 5, 5, NULL, NULL),
...
(12, 'DESIGN AND ANALYSIS OF ALGORITHM', 'BCA', 4, 5, NULL, NULL),
(13, 'WEB PROGRAMING USING PHP', 'BCA', 4, 5, NULL, NULL),
...
--
ALTER TABLE `notes`
  MODIFY `NOTE_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
